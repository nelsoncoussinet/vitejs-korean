                ...
                return (
                  <>
                    ...
                    >
                      ...
                      <td style={tdStyle}>{r.fr || "—"}</td>
                      <td style={{ ...tdStyle, color: "#999" }}>{r.en || "—"}</td>
                      {!isMobile && <td style={tdStyle}><TopikBadge v={r.topik_objectif} /></td>}
                      {!isMobile && <td style={tdStyle}><MultiTag val={r.usage} /></td>}
                      {!isMobile && <td style={tdStyle}><MultiTag val={r.theme} /></td>}
                      <td style={tdStyle}>
                          ...
                          <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", gap: 12, fontSize: 13 }}>
                            <div>
                              ...
                              {editingField?.id === r.id && editingField?.field === "fr" ? (
                                ...
                                <div
                                  onClick={() => {
                                    setEditingField({ id: r.id, field: "fr" });
                                    setEditValue(r.fr || "");
                                  }}
                            ...
                            <div>
                              ...
                              {editingField?.id === r.id && editingField?.field === "en" ? (
                                ...
                                <div
                                  onClick={() => {
                                    setEditingField({ id: r.id, field: "en" });
                                    setEditValue(r.en || "");
                                  }}
                                  style={{ cursor: "text", padding: "6px 8px", borderRadius: 6, border: "1px dashed #ddd", minHeight: 40, background: "#fff" }}
                                >
